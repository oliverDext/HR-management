	...
	<div id="main">
		...
		<div id="site_content">
			...
			while(rs.next())
			{
				...
				out.print("<td>"+rs.getString("option1")+"</td>");
				out.print("<td>"+rs.getString("option2")+"</td>");
				out.print("<td>"+rs.getString("option3")+"</td>");
				out.print("<td>"+rs.getString("correct")+"</td>");
				out.print("<td><a href='deletequestion.jsp?name="+rs.getString("correct")+"' class='myButton'>Delete</a>");
				out.print("</tr>");
			}
			out.print("</table>");
			out.print("</form>");
