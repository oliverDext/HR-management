...
<body>
	...
	<%
			...
			try
			{
			String message="Click here for test";
			...
			PreparedStatement ps = con.prepareStatement("select * from message where loginname='"+username+"'");
			ResultSet rs=ps.executeQuery();
			if(rs.next()==true)
			{
				if(username.equals(rs.getString("loginname")));
                                 {
					ps=con.prepareStatement("update message set message=? where loginname='"+username+"'");
				        ps.setString(1,message);
					int z=ps.executeUpdate();  
	   			        if(z>0)
	   				  {
               					 out.print("You have successfully Send...");
	     				 %>
	...
	<%
			...
			else
			{
					...
					if(z>0)
					{
						...
						out.print("<h1>You have successfully Send </h1>"); 
					%>
	<jsp:include page="userdetails.jsp"></jsp:include>
	<%
