...
<body>
	...
	<%
			...
			PreparedStatement ps = con.prepareStatement("delete from question where correct='"+username+"'");
			int z=ps.executeUpdate();
			if(z>0)
			{
		
			out.print("<h1>You have successfully deleted </h1>"+username); 
		%>
	<jsp:include page="showquestion.jsp"></jsp:include>
	<%
		}
		}
	catch(Exception e)
