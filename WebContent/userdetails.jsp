...
<body>
	...
	<div id="main">
		...
		<div id="site_content">
			...
			{
				out.print("<tr>");
				out.print("<td><a href='printuserprofile.jsp?username="+rs.getString("loginname")+"'>"+rs.getString("loginname")+"</a></td>");
				out.print("<td>"+rs.getString("gender")+"</td>");
				out.print("<td>"+rs.getString("dob")+"</td>");
				out.print("<td>"+rs.getString("experience")+"</td>");
				out.print("<td>"+rs.getString("skills")+"</td>");
				out.print("<td><a href='delete.jsp?username="+rs.getString("loginname")+"' class='myButton'>Delete</a>");
				out.print("</tr>");
			}
			out.print("</table>");
			out.print("</form>");
