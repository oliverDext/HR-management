...
<body>
	...
	<%
			...
			PreparedStatement ps = con.prepareStatement("update  message set  message=? where loginname='"+username+"'");
			
			String message="You are shortlisted & Ready for other rounds...";
		...
		%>
	<jsp:include page="showresult.jsp"></jsp:include>
	<%
