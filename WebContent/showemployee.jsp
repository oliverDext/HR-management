...
<body>
	...
	<div id="main">
		...
		<div id="site_content">
			...
			{
				out.print("<tr>");
				out.print("<td><a href='printemployeeprofile.jsp?username="+rs.getString("empid")+"'>"+rs.getString("empid")+"</a></td>");
				out.print("<td>"+rs.getString("empname")+"</td>");
				out.print("<td>"+rs.getString("empfather")+"</td>");
				out.print("<td>"+rs.getString("empprojects")+"</td>");
				out.print("<td>"+rs.getString("empjobtype")+"</td>");
				out.print("<td>"+rs.getString("empsalary")+"</td>");
				
				out.print("<td><a href='deleteemployee.jsp?username="+rs.getString("empid")+"' class='myButton'>Delete</a>");
				out.print("<td><a href='updateemployee.jsp?username="+rs.getString("empid")+"' class='myButton'>Update</a>");
