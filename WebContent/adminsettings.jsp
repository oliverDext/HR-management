...
<script type="text/javascript">
	...
	{  
		...
		var url = "changeadminpassword.jsp?opw="+op+"&npw="+np;  
...
<body>
	...
	<div id="main">
		...
		out.print(su.toUpperCase()); %>
			...
			<div id="menubar">
				<ul id="menu">
					<li><a href="adminsettings.jsp">Profile</a></li>
		...
		<div id="site_content">
			<div id="content">
				<div class="content_item">
					...
					<form action="adminphoto.jsp" method="post"
		...
		%>
			...
			PreparedStatement pst = con.prepareStatement("select * from hruser where loginname='"+su+"'");
			...
			<div class="sidebar_container">
				<div class="sidebar">
					...
					<div class="sidebar_item">
						...
						<% String un1 = (String)session.getAttribute("sessionadmin");
